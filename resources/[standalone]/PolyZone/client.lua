...
function DrawLine(x,y,z,_x,_y,_z,r,g,b,a)
  return Citizen.InvokeNative(GetHashKey("DRAW_LINE") & 0xFFFFFFFF, x, y, z, _x, _y, _z, r, g, b, a)
end

function DrawMarker(type, posX, posY, posZ, dirX, dirY, dirZ, rotX, rotY, rotZ, scaleX, scaleY, scaleZ, red, green, blue, alpha, bobUpAndDown, faceCamera, p19, rotate, drawonEnts)
  return Citizen.InvokeNative(0x2A32FAA57B937173, type, posX, posY, posZ, dirX, dirY, dirZ, rotX, rotY, rotZ, scaleX, scaleY, scaleZ, red, green, blue, alpha, bobUpAndDown, faceCamera, p19, rotate, drawonEnts)
end